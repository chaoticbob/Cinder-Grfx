...
#define CINDER_CONTEXT_BINDING_SHIFT_TEXTURE 0
#define CINDER_CONTEXT_BINDING_SHIFT_UBO	 (CINDER_CONTEXT_BINDING_SHIFT_TEXTURE + CINDER_CONTEXT_MAX_TEXTURE_COUNT)
#define CINDER_CONTEXT_BINDING_SHIFT_IMAGE	 (CINDER_CONTEXT_BINDING_SHIFT_UBO + CINDER_CONTEXT_MAX_UBO_COUNT)
#define CINDER_CONTEXT_BINDING_SHIFT_SAMPLER (CINDER_CONTEXT_BINDING_SHIFT_IMAGE + CINDER_CONTEXT_MAX_IMAGE_COUNT)
#define CINDER_CONTEXT_BINDING_SHIFT_SSBO	 (CINDER_CONTEXT_BINDING_SHIFT_SAMPLER + CINDER_CONTEXT_MAX_SAMPLER_COUNT)
